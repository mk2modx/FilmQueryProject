...
public class Film {
	...
	public Film(String title, String description, int year, String languageId, int rentalDuration, double rentalRate,
	...
	public String toString() {
		return "Film [title=" + title + ", description=" + description + ", year=" + year + ", rentalDuration="
